...
- **Database Hosting:**
   - ElephantSQL (PostgreSQL database) - [https://www.elephantsql.com/](https://www.elephantsql.com/)
...
Please note that it's assumed Python is installed on the computer or IDE cloud based platform for deploying this project. If you haven't installed Python yet, you'll need to download and install it from the [official Python website](https://www.python.org/downloads/) before proceeding with the deployment process.
...
1. **Update Database Setting:**
    ...
    **_IMPORTANT:_** Do not commit this change with your database URL. This step is temporary for migration purposes.
...
1. Go to the [GitHub repository](https://github.com/AleksandrAtr/darianna-creative).
